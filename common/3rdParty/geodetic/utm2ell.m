...
%
%   *** NOTE *** For points in southern hemisphere either subtract
%   10,000,000 m from northings or use negative zone values (-1 if
%   using optional lcm).
%
% Version: 2014-04-11
% Usage:   [lat,lon]=utm2ell(N,E,Zone,a,e2,lcm)
...
% Created 2011-04-03
% Revised 2013-05-10 Corrected function name (was ell2utm)
% Revised 2014-04-11 Corrected test for points in southern hemisphere by
%					 using negative zones, and removed false northings &
%					 eastings near beginning of function.
%
%
% 2016-11-10 A.Leichtman   Changed default ellipsoid to 'WGS84'
